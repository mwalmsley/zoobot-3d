...
#   "main_options[useDeProjectStretch]": "1",
  "main_options[useDeProjectStretch]": "0",
...
#   "main_options[useImageStandardization]": "1",
  "main_options[useImageStandardization]": "0",
  "main_options[resizeDims]": "'[256 256]'"
#   "main_options[resizeDims]": "'[224 224]'"
}
...
def download(destdirp, query_id, galaxy_name):
  ...
  print('\n') # adds a newline after wget progress bar
...
if __name__ == '__main__':
  ...
  parser.add_argument('srcdir', help='a directory of source files', default='/Users/user/repos/zoobot-3d/data/sparcfire/fits')
  parser.add_argument('destdir', help='a directory for output files', default='/Users/user/repos/zoobot-3d/data/sparcfire/results')
  parser.add_argument('-o', '--output', dest='output',
    help='an output file for queryID corresponding to galaxy names', default='/Users/user/repos/zoobot-3d/data/sparcfire/results/queryID.txt')
